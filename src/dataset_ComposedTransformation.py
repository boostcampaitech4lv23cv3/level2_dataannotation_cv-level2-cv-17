...
def cal_error(vertices):
    ...
    default orientation is
        x1y1 : left-top, x2y2 : right-top,
        x3y3 : right-bot, x4y4 : left-bot
...
class SceneTextDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        Geotransform = ComposedTransformation(
            rotate_anchors=None,
            rotate_range=90,
            ...
            min_image_overlap=0.9,
            min_bbox_overlap=0.99,
            min_bbox_count=1,
        ...
        transformed = Geotransform(image=image, word_bboxes=bboxes)
