...
# MODEL_PATH = "/opt/ml/code/pths/"
MODEL_PATH = "/opt/ml/level2_dataannotation_cv-level2-cv-17/"
...
class Extractor(nn.Module):
    def __init__(self, pretrained):
        super().__init__()
        vgg16_bn = VGG(make_layers(LAYERS, batch_norm=True))
        if pretrained:
            vgg16_bn.load_state_dict(torch.load(f"{MODEL_PATH}vgg16_bn-6c64b313.pth"))
